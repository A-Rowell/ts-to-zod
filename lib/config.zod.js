...
exports.tsToZodConfigSchema = exports.configsSchema = exports.configSchema = exports.customJSDocFormatTypesSchema = exports.customJSDocFormatTypeSchema = exports.customJSDocFormatTypeAttributesSchema = exports.jSDocTagFilterSchema = exports.nameFilterSchema = exports.getSchemaNameSchema = exports.simplifiedJSDocTagSchema = void 0;
...
exports.jSDocTagFilterSchema = zod_1.z
    ...
    .returns(zod_1.z.boolean());
exports.customJSDocFormatTypeAttributesSchema = zod_1.z.object({
    regex: zod_1.z.string(),
    errorMessage: zod_1.z.string().optional(),
});
exports.customJSDocFormatTypeSchema = zod_1.z.string();
exports.customJSDocFormatTypesSchema = zod_1.z.record(exports.customJSDocFormatTypeSchema, zod_1.z.union([zod_1.z.string(), exports.customJSDocFormatTypeAttributesSchema]));
exports.configSchema = zod_1.z.object({
    ...
    inferredTypes: zod_1.z.string().optional(),
    customJSDocFormatTypes: exports.customJSDocFormatTypesSchema.optional(),
});
